<?php
    ...
    if ($choice == "id"){
        $inserted = "SELECT * FROM validNumberPlates WHERE companyID = $compID";
    }elseif($choice == "inval"){
        $inserted = "SELECT * FROM validNumberPlates WHERE companyID = $compID ORDER BY valid";
    }else{
        $inserted = "SELECT * FROM validNumberPlates WHERE companyID = $compID ORDER BY numberPlate";
    }
